...
def interface():
    ...
    if st.session_state.stage > 0:
        ...
        headers =  ['NAICS Code','Prevailing Wage Level','Prevailing Wage Amount','Work State','Class of Admission','Country of Citizenship','Employer Number of Employees','Job Education','Experience','Months of Experience','Layoff in Past Six Months','Education']
        data = {}
        for i in range(len(headers)):
            data['Question'] = headers
            data['Answer'] = smt

...
def interface():
    ...
    st.subheader("This predictive dashboard predicts the waiting time from the date the application was received by OFLC to the date a decision was made by OFLC for green
